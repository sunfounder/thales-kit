...
SunFounder |link_Thales_kit| for Raspberry Pi Pico 
===========================================================

* |link_Thale_kit|

SunFounder |link_Thales_kit| is a basic learning kit based on Raspberry Pi Pico.
...
* :download:`SunFounder Thales Kit Scripts <https://github.com/sunfounder/thales_kit/archive/refs/heads/master.zip>`

* Or check out the code at `Thales Kit - GitHub <https://github.com/sunfounder/thales_kit>`_

.. toctree::
    :maxdepth: 3

    introduction_to_raspberry_pi_pico
    components/what_is_included_in_this_kit
